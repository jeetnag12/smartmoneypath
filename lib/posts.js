    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    targetSlug = category.toLowerCase().replace(/[^a-z0-9]+/g, '-');
                    return [2 /*return*/, getProcessedPosts().filter(function (post) { return post.category.toLowerCase().replace(/[^a-z0-9]+/g, '-') === targetSlug; })];
            }
        });
    });
}
