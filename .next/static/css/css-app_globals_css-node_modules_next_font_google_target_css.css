...
.border-darkGreen {
  --tw-border-opacity: 1;
  border-color: rgb(27 94 32 / var(--tw-border-opacity, 1));
}
.border-gray-100 {
  --tw-border-opacity: 1;
...
.from-primary-100 {
  --tw-gradient-from: #C8E6C9 var(--tw-gradient-from-position);
  --tw-gradient-to: rgb(200 230 201 / 0) var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
}
.from-primary-50 {
...
.to-primary-700 {
  --tw-gradient-to: #388E3C var(--tw-gradient-to-position);
}
.to-secondary-100 {
...
.hover\:bg-\[\#006396\]:hover {
  --tw-bg-opacity: 1;
  background-color: rgb(0 99 150 / var(--tw-bg-opacity, 1));
}
...
.focus\:ring-brightGreen\/30:focus {
  --tw-ring-color: rgb(76 175 80 / 0.3);
}
